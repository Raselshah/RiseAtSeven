...
export default function Hero() {
  ...
  return (
    <section ref={heroRef} className="relative   overflow-hidden h-screen w-[calc(100vw-32px)] mx-auto rounded-4xl">
      {/* SVG Circle Reveal Mask */}
      <div className="fixed inset-0 w-full h-screen z-[100] pointer-events-none hidden lg:block">
        <svg width="100%" height="100%" viewBox="0 0 1920 1080" preserveAspectRatio="none" className="block w-screen h-screen">
          <defs>
  ...
  />
      ...
      {/* Background Image */}
      <div className="absolute inset-0 bg-grey-900 ">
...
"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-white text-center px-4">
        <div className="mb-4">
          <div className="uppercase text-xs font-medium tracking-tightish max-w-52 text-balance text-center mb-2 text-white">
            #1 Most recommended content marketing agency
          </div>
          <div className="flex items-center justify-center gap-2">
            <svg viewBox="0 0 28 38" fill="none" className="w-6 fill-current text-white">
            ...
            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/global-search-awards.png" className="h-6 object-contain" alt="" />
            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/Mask-group.png" className="h-6 object-contain" alt="" />
            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Awards/White/UKSocial-Media-Awards-White.png" className="h-6 object-contain" alt="" />
            <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Awards/White/UK-Content-Awards-White.png" className="h-6 object-contain hidden lg:block" alt="" />
        ...
        <div ref={headingRef} className="text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-medium tracking-tight leading-[1.1] max-w-6xl">
          <div className="flex flex-wrap justify-center overflow-hidden">
            <span className="word inline-block mr-2 opacity-0">We</span>
            <span className="word inline-block opacity-0">Create</span>
          </div>
          <div className="flex flex-wrap justify-center items-center overflow-hidden mt-2 md:mt-4">
            <span className="word inline-block mr-2 opacity-0">Category</span>
            <span className="word inline-block relative w-20 h-20 md:w-28 md:h-28 rounded-full overflow-hidden bg-black/20 mx-2">
              <img src="https://rise-atseven.transforms.svdcdn.com/production/images/unnamed-6.png?w=213&h=278&q=100&auto=format&fit=crop&dm=1750948726&s=0ecee9869674cd309d3170dfd7b29674
" className="w-full h-full object-cover" alt="" />
            </span>
            <span className="word inline-block opacity-0">Leaders</span>
          </div>
        </div>
        
        <p className="text-lg md:text-xl lg:text-2xl mt-6 max-w-2xl text-center opacity-0 animate-fadeInUp animation-delay-500">
          on every searchable platform
        </p>

        {/* Platform Logos - Desktop only */}
        <div className="hidden 3xl:flex gap-14 mt-12 justify-center opacity-70">
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/gogle.png" className="h-6 object-contain" alt="Google" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/chat-gpt.png" className="h-6 object-contain" alt="ChatGPT" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/gemini.png" className="h-6 object-contain" alt="Gemini" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/tiktok.png" className="h-6 object-contain" alt="TikTok" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Placeholder-logos/youtube.png" className="h-6 object-contain" alt="YouTube" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/pinterest.png" className="h-6 object-contain" alt="Pinterest" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/giphy.png" className="h-6 object-contain" alt="Giphy" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/reddit.png" className="h-6 object-contain" alt="Reddit" />
          <img src="https://rise-atseven.transforms.svdcdn.com/production/images/Logos/Social/White/amazon.png" className="h-6 object-contain" alt="Amazon" />
        </div>

        {/* Bottom Info */}
        <div className={`absolute bottom-6 left-6 right-6 flex flex-col sm:flex-row justify-between text-[16px] text-white gap-2 transition-all duration-700 delay-700 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
         <span className='flex flex-col'>
           <span>Organic media planners creating, distributing & optimising </span>
           <span className="">search-first content for SEO, Social, PR, Ai and LLM search</span>
         </span>
          <span className='text-[16px] flex flex-col '><span>
